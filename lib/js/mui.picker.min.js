	...
	e.PopPicker = e.Class.extend({
		init: function(n) {
			...
			a.options = n || {}, a.options.buttons = a.options.buttons || ["取消", "确定"], a.panel = e.dom(i)[0], t.body.appendChild(
					...
					".mui-poppicker-btn-cancel"), a.body = a.panel.querySelector(".mui-poppicker-body"), a.mask = e.createMask(function(){
						var main = plus.webview.getWebviewById("html/browse/browse.html");
						mui.fire(main, 'wudingce', {
							
						})
						var mainname = plus.webview.getWebviewById("Createaferry.html");
						mui.fire(mainname, 'changetextFlase', {
						valuetext: false
						})
                      var mainname = plus.webview.getWebviewById("CreateaCompany.html");
                      mui.fire(mainname, 'changetextFlase', {
                         valuetext: false
                         })
